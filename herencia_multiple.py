...
lista_enteros_ordenada.agregar_elemento(-20)
print(lista_enteros_ordenada)
# Saber las clases padres y su orden
print(ListaEnterosOrdenada.__bases__)
print(ListaEnterosOrdenada.__mro__) # MRO (Method Resolution Order)
# isisntance
print('Es entero?',isinstance(10,int))
print('Es cadena?',isinstance('hola',str))
print('Es lista enteros ord?',isinstance(lista_enteros_ordenada, ListaEnterosOrdenada))
print('Es lista enteros?',isinstance(lista_enteros, ListaEnteros))
print('Es lista ord?',isinstance(lista_enteros_ordenada, ListaOrdenada))
print('Es lista simple?',isinstance(lista_simple, ListaSimple))
print('Es object', isinstance(lista_enteros_ordenada, object))
print('Es de varios tipos?',isinstance(lista_enteros_ordenada, (ListaEnteros,ListaEnterosOrdenada,)))