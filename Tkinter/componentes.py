...
class ComponentesVentana(tk.Tk):
    ...
    def _crear_componentes_tabulador1(self,tabulador):
        # Agreagar una etiqueta y un componente de entrada
    ...
    def _crear_componentes_tabulador3(self,tabulador):
        ...
        combobox.current(4) # Va segun los indices
    ...
    def _crear_componentes_tabulador5(self,tabulador):
        ...
        def ejecutar_barra():
            ...
            for valor in range(101):
                ...
                # Actualizar la barra de progresos
        ...
        boton_despues = ttk.Button(tabulador,
                                   text='Detener Ejecucion despues', command=detener_despues)
    ...
    def _crear_tabs(self):
        ...
        # Creamos los compontentes del tabulador1
        ...
        # Creamos los compontentes del segundo tabulador
        self._crear_componentes_tabulador2(tabulador2)
        # Ceramos un tercer tabulador
        ...
        # Creamos los componentes del 4 tabulador
        self._crear_componentes_tabulador4(tabulador4)
        # Creamo un quinto tabulador
