...
class Calculadora(tk.Tk):
    def __init__(self):
        ...
        self.resizable(0,0)
        self.title('Calculadora Devkitty')
    ...
    # Metodos de clase
    #Metodos para crear los componetnes
    def _creacion_componentes(self):
        ...
        # Caja de texto
        entrada_frame = tk.Entry(entrada_frame,
                                 font=('aarial',18, 'bold'),textvariable=self.entrada_texto, width=30, justify=tk.RIGHT)

        entrada_frame.grid(row=0,column=0, ipady=10)

        # Creamos otro frame para la parte inferior
        botones_frame = tk.Frame(self, width=400, height=450, bg='grey')
        botones_frame.pack()

#       Primer row (Boton Limpiar)
    ...
    def _evento_evaluar(self):
        ...
        try:
            ...
            messagebox.showerror('Error',f'Ocurrio un error: {error}, {type(error)}')
